...
export const AUSLAN_GESTURES: Gesture[] = [
  ...
  { id: '1', name: '1', category: 'numbers', description: 'Number one in AUSLAN', instructions: 'Hold up index finger', difficulty: 'easy', imageUrl: '/lovable-uploads/72c9e454-f3af-4e59-9a5b-c8a2452fe068.png' },
