...
export const AUSLAN_GESTURES: Gesture[] = [
  ...
  { id: '4', name: '4', category: 'numbers', description: 'Number four in AUSLAN', instructions: 'Hold up four fingers, thumb tucked', difficulty: 'easy', imageUrl: '/lovable-uploads/5f3c1737-afa9-4d5a-9b8e-b52140e789f0.png' },
